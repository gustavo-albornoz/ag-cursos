            ...
            {dropdownOpen && (
              <div className="absolute top-full left-0 mt-2 w-64 bg-white border rounded-xl shadow-lg overflow-hidden z-50">
                <Link
                  ...
                  className="block px-4 py-3 text-sm font-semibold text-blue-600 hover:bg-blue-50 border-b transition"
                >
                ...
                {courses.length === 0 ? (
                  ...
                  courses.map(course => (
                    <Link
                      ...
                      onClick={() => setDropdownOpen(false)}
                      className="block px-4 py-3 text-sm text-gray-700 hover:bg-gray-50 transition border-b last:border-0"
                    >
                      {course.title}
                    </Link>
                  ))
